...
def tuto_confirm(cla):
    try:
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\confirm_1.PNG"
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\confirm_2.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        while ing_ is False:
            ...
            if ing_count > 5:
                ...
                if ing_count > 20:
                    ing_ = True
                    print("무언가 잘못 되었다.")
            full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\go_quest.PNG"
            img_array = np.fromfile(full_path, np.uint8)
            img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def quest_clear_click(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\quest_clear_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(640, 70, 690, 120, cla, img, 0.8)
        if imgs_ is not None and imgs_ != False:
...
def tuto_skip(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\skip_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            print("skip_1", imgs_)
            click_pos_reg(imgs_.x, imgs_.y, cla)
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\skip_2.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def tuto_status(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_status_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            ...
            while is_stat_ is False:
                ...
                img_array = np.fromfile(full_path, np.uint8)
                img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
                imgs_ = imgs_set_(57, 135, 71, 153, cla, img, 0.8)
                if imgs_ is not None and imgs_ != False:
...
def tuto_quest_moglog(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_quest_moglog_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def tuto_bag_touch(cla):
    try:
        import cv2
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2, drag_pos
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(630, 150, 900, 260, cla, img, 0.8)
        if imgs_ is not None and imgs_ != False:
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_2.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            ...
            time.sleep(0.1)
            click_pos_2(730, 385, cla)
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_3.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            ...
            click_pos_2(730, 385, cla)
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_4.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_5.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_6.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_7.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_8.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_9.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_10.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_11.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_bag_touch_12.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def tuto_camera_setting(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\camera_setting_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def tuto_new_skill(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2, drag_pos
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_2.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            ...
            time.sleep(0.1)
            click_pos_2(730, 390, cla)
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_3.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_4.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_5.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_6.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_7.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(210, 830, 350, 870, cla, img, 0.8)
        if imgs_ is not None and imgs_ != False:
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_new_skill_8.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def tuto_talgut(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_2.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            ...
            click_pos_2(730, 390, cla)
        #중복
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_3.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_4.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        imgs_ = imgs_set_(330, 930, 600, 1030, cla, img, 0.8)
        if imgs_ is not None and imgs_ != False:
            ...
            click_pos_reg(imgs_.x, imgs_.y, cla)
        #
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_5.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_6.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_7.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_8.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_talgut_9.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def tuto_sangjum(cla):
    try:
        ...
        import numpy as np
        from function import click_pos_reg, imgs_set_, click_pos_2
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_sangjum_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_sangjum_2.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_sangjum_3.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_sangjum_4.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
def tuto_groa(cla):
    try:
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_groa_1.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            ...
            click_pos_2(770, 55, cla)
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_groa_2.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_groa_3.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        if imgs_ is not None and imgs_ != False:
            ...
            click_pos_2(900, 55, cla)
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_groa_4.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_groa_5.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
        ...
        full_path = "c:\\acaw\\my_acaw\\imgs\\tuto\\tuto_groa_6.PNG"
        img_array = np.fromfile(full_path, np.uint8)
        img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
#         import numpy as np
#         from function import click_pos_reg, imgs_set_, click_pos_2
#         full_path = "c:\\acaw\\my_acaw\\imgs\\box\\moogi_select_box_1.PNG"
#         img_array = np.fromfile(full_path, np.uint8)
#         img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
...
#             time.sleep(1)
#             from function import click_pos_reg, imgs_set_, click_pos_2
#             full_path = "c:\\acaw\\my_acaw\\imgs\\box\\moogi_select_box_2.PNG"
#             img_array = np.fromfile(full_path, np.uint8)
#             img = cv2.imdecode(img_array, cv2.IMREAD_COLOR)
